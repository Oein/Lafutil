// ==UserScript==
// @name        Lafutil
// @description Make laftel better
// @match       *://*.laftel.net/*
// ==/UserScript==

let tryingSignin = false;
let observing = false;
let videoFullSized = false;
...
const selectors = {
  video: "#root > .App > div:nth-child(2) > div:first-child > div:first-child",
  fullscreenButton:
    "#video-controls-below > div:nth-child(2) > div:nth-child(3) > div:nth-child(3) > button",
};
...
function createLafutilConfigPage() {
  ...
  function createInpEle(type) {
    ...
    inpName.style.whiteSpace = "nowrap";
  ...
  let configs = ["Auto Sign in API URL"];
